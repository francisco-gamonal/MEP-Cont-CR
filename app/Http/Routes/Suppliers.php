...
Route::delete('proveedores/delete/{token}', ['as' => 'delete-proveedores', 'uses' => 'SupplierController@destroy']);
Route::patch('proveedores/active/{token}', ['as' => 'active-proveedores', 'uses' => 'SupplierController@active']);
