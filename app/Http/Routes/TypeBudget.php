...
Route::delete('tipos-de-presupuestos/delete-tipos-de-usuarios/{token}',['as'=>'delete-tipo-de-presupuesto','uses'=>'TypeBudgetsController@destroy']);
Route::patch('tipos-de-presupuestos/active-tipos-de-usuarios/{token}',['as' => 'active-tipo-de-presupuesto', 'uses' => 'TypeBudgetsController@active']);
