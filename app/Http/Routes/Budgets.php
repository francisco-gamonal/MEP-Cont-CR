...
Route::get('presupuestos/registrar-presupuestos', ['as' => 'registrar-presupuesto', 'uses' => 'BudgetsController@create']);
Route::post('presupuestos/save-presupuestos', 'BudgetsController@store');
Route::get('presupuestos/editar-presupuestos/{token}', ['as' => 'edit-presupuesto', 'uses' => 'BudgetsController@edit']);
