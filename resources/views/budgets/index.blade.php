                        	...
                        	@foreach($budgets as $budget)
	                            <tr>
	                                ...
	                                <td class="text-center edit-row">
										<a  target="_blank" class="validateReport" href="{{route('report-presupuestos', $budget->token)}}" data-url="institucion/inst/presupuestos"><i class="fa fa-file-pdf-o"></i></a>
										<a  target="_blank" class="validateReport" href="{{route('reporte-presupuesto-excel', $budget->token)}}" data-url="institucion/inst/presupuestos"><i class="fa fa-file-excel-o"></i></a>
	                                </td>
	                                <td class="text-center edit-row">
	                                    <a target="_blank" href="{{route('actual-presupuestos', $budget->token)}}" data-url="institucion/inst/presupuestos"><i class="fa fa-file-pdf-o"></i></a>
